...
class PartialFormatterTests: XCTestCase {
    ...
    func testAENumberWithThaiNumerals() {
    ...
    func testAENumberWithMixedThaiNumerals() {
        // HELP WANTED: Tests with Correct Region
        // let partialFormatter = PartialFormatter(phoneNumberKit: phoneNumberKit, defaultRegion: "AE")
        // var testNumber = "+"
        // XCTAssertEqual(partialFormatter.formatPartial(testNumber), "+")
    ...
    // +๙๗๑๕๐๐๕๐๐๕๕๐ (+971500500550)
    func testAENumberWithKhmerNumerals() {
        // HELP WANTED: Tests with Correct Region
        //  let partialFormatter = PartialFormatter(phoneNumberKit: phoneNumberKit, defaultRegion: "AE")
        //  var testNumber = "+"
        //  XCTAssertEqual(partialFormatter.formatPartial(testNumber), "+")
    ...
    // +๙๗๑5๐๐5๐๐55๐ (+971500500550)
    func testAENumberWithMixedKhmerNumerals() {
        // HELP WANTED: Tests with Correct Region
        //  let partialFormatter = PartialFormatter(phoneNumberKit: phoneNumberKit, defaultRegion: "AE")
        //  var testNumber = "+"
        //  XCTAssertEqual(partialFormatter.formatPartial(testNumber), "+")
    ...
    // +๙๗๑๕๐๐๕๐๐๕๕๐ (+971500500550)
    func testAENumberWithTamilNumerals() {
        // HELP WANTED: Tests with Correct Region
        //  let partialFormatter = PartialFormatter(phoneNumberKit: phoneNumberKit, defaultRegion: "AE")
        //  var testNumber = "+"
        //  XCTAssertEqual(partialFormatter.formatPartial(testNumber), "+")
    ...
    // +๙๗๑5๐๐5๐๐55๐ (+971500500550)
    func testAENumberWithMixedTamilNumerals() {
        // HELP WANTED: Tests with Correct Region
        //  let partialFormatter = PartialFormatter(phoneNumberKit: phoneNumberKit, defaultRegion: "AE")
        //  var testNumber = "+"
        //  XCTAssertEqual(partialFormatter.formatPartial(testNumber), "+")
    ...
    // +๙๗๑๕๐๐๕๐๐๕๕๐ (+971500500550)
    func testAENumberWithBengaliNumerals() {
        // HELP WANTED: Tests with Correct Region
        //  let partialFormatter = PartialFormatter(phoneNumberKit: phoneNumberKit, defaultRegion: "AE")
        //  var testNumber = "+"
        //  XCTAssertEqual(partialFormatter.formatPartial(testNumber), "+")
    ...
    // +๙๗๑5๐๐5๐๐55๐ (+971500500550)
    func testAENumberWithMixedBengaliNumerals() {
        // HELP WANTED: Tests with Correct Region
        //  let partialFormatter = PartialFormatter(phoneNumberKit: phoneNumberKit, defaultRegion: "AE")
        //  var testNumber = "+"
        //  XCTAssertEqual(partialFormatter.formatPartial(testNumber), "+")
        ...
        // +๙๗๑๕๐๐๕๐๐๕๕๐ (+971500500550)
    func testAENumberWithBurmeseNumerals() {
        // HELP WANTED: Tests with Correct Region
        //  let partialFormatter = PartialFormatter(phoneNumberKit: phoneNumberKit, defaultRegion: "AE")
        //  var testNumber = "+"
        //  XCTAssertEqual(partialFormatter.formatPartial(testNumber), "+")
    ...
    // +๙๗๑5๐๐5๐๐55๐ (+971500500550)
    func testAENumberWithMixedBurmeseNumerals() {
        // HELP WANTED: Tests with Correct Region
        //  let partialFormatter = PartialFormatter(phoneNumberKit: phoneNumberKit, defaultRegion: "AE")
        //  var testNumber = "+"
        //  XCTAssertEqual(partialFormatter.formatPartial(testNumber), "+")
    ...
    // +๙๗๑๕๐๐๕๐๐๕๕๐ (+971500500550)
    func testAENumberWithEastAsiaNumerals() {
        //  let partialFormatter = PartialFormatter(phoneNumberKit: phoneNumberKit, defaultRegion: "AE")
        //  var testNumber = "+"
        //  XCTAssertEqual(partialFormatter.formatPartial(testNumber), "+")
        //  testNumber = "+๙"
    ...
    // +๙๗๑5๐๐5๐๐55๐ (+971500500550)
    func testAENumberWithMixedEastAsiaNumerals() {
        //  let partialFormatter = PartialFormatter(phoneNumberKit: phoneNumberKit, defaultRegion: "AE")
        //  var testNumber = "+"
        //  XCTAssertEqual(partialFormatter.formatPartial(testNumber), "+")
        //  testNumber = "+๙"
